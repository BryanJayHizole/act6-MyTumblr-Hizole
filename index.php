...
$acc_username = "Bryanjay";
$acc_password = "hizole14";
$acc_fullname = "Bryan Jay J. Hizole";
...
if (isset($_REQUEST['login_button']) === true){
	//get the username and password from the form and compare the predefined username and password
